...
<head>
    ...
    <script>
        $(document).ready(function () {
            var myHeight = $(window).height() - 70;
            $('.thumb img').on('click', function () {
                var src = $(this).attr('src');
                var img = '<img src="' + src + '" class="img-responsive"/>';
                var imgWidth = this.naturalWidth;
                $('.modal-dialog').width(imgWidth);
                $('.modal-body img').height = myHeight;
                $('#myModal').modal();
                $('#myModal').on('shown.bs.modal', function () {
                    $('#myModal .modal-body').html(img);
                    $('.modal-body img').css("max-height", myHeight);
                    var paddingHeight = ($(window).height() - $(".modal-body").height()) / 2;
                    $(".modal-body").css("padding-top", paddingHeight);
    ...
    <div id="slide1">
        <div class="wrapper">
            ...
            <video class="myVideo" autoplay loop muted>
              <source src="images/Untitled.webm" type="video/webm" />
                <source src="images/Untitled.mp4" type="video/mp4" />
                <source src="images/Untitled.ogv" type="video/ogg" />
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <button type="button2" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a class="button2" href="#slide2">Page 2</a></li>
                        <li><a class="button2" href="#slide4">Page 444</a></li>
                        <li><a class="button2" href="#slide7">Page 6</a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 thumb">
                            <a class="thumbnail2">
                                <img class="img-responsive" src="images/lol.png" alt="">
                            </a>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 thumb">
                            <a class="thumbnail2">
